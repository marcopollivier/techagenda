...
export default function TagPicker({ tags, selectedTags, setSelected }: TagPickerProps) {
        ...
        <div className="autcomplete-wrapper">
            <Combobox value={selectedTags} onChange={addTag} multiple>
                <div className="relative mt-1">
                    <div className="autcomplete w-full flex flex-col items-center mx-auto">
                                ...
                                <div className="flex flex-auto flex-wrap w-full items-center">
                                    {
                                        selectedTags.map((tag, index) => {
                                            return (
                                                <div key={index} className="flex justify-center items-center m-1 font-medium py-1 px-2 rounded-full text-white bg-blue-500">
