    ...
    <div className="relative isolate overflow-hidden bg-blue-500 shadow-2xl rounded-3xl lg:flex h-1/6">
      <div className="ml-6 max-w-md text-center lg:flex-auto lg:py-32 lg:text-left">
        ...
        <div className="flex mt-10">
          <a
            href="#"
            className="flex items-center justify-between rounded-full bg-white px-4 py-2.5 text-sm font-semibold text-blue-500 shadow-sm hover:bg-gray-100 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"
          >
            <CursorArrowRaysIcon
